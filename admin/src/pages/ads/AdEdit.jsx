...
const POSITIONS = [
  ...
  { value: 'sidebar-6',       label: 'Sidebar — Slot 6 (between 2 and 3)' },
  { value: 'sidebar-7',       label: 'Sidebar — Slot 7 (between 2 and 3)' },
  { value: 'sidebar-8',       label: 'Sidebar — Slot 8 (between 2 and 3)' },
