...
const EMPTY = { title: '', slug: '', body: '', meta_title: '', meta_description: '', is_published: false, display_order: 0 };
...
export default function ReportEdit() {
  ...
  async function save(publish) {
    ...
    try {
      if (isNew) {
        const { id: newId } = await api.createReport(payload);
    ...
    <div>
      <PageHeader
        ...
        action={
          <div style={{ display: 'flex', gap: 8 }}>
            <Btn variant="outline" onClick={() => navigate('/admin/reports')}>← Reports</Btn>
            {!form.is_published && (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 24, alignItems: 'start' }}>
          ...
          <Card>
            <Field label="Title">
              <Input
                ...
                placeholder="Q3 2026 Compliance Report"
                style={{ fontSize: 18, fontWeight: 600 }}
              />
            </Field>

            <Field label="Slug" hint={`Public URL: /r/${form.slug || 'your-slug'}`}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 0 }}>
                ...
                <input
                  ...
                  placeholder="q3-2026-compliance"
                />
              </div>
            </Field>

            <Field label="HTML / Iframe Body" hint="Paste raw HTML — iframes are allowed. Report pages render full-width. <script> tags will be stripped.">
              <Textarea
                value={form.body}
                onChange={e => set('body', e.target.value)}
                placeholder={`<iframe src="https://example.com/dashboard" style="width:100%; height:900px; border:none;"></iframe>`}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Card>
            <div style={{ fontWeight: 600, fontSize: 13, marginBottom: 14 }}>Menu Order</div>
            <Field label="Display order" hint="Lower numbers appear first in the Reports submenu">
              <Input
                type="number"
          ...
          <Card>
            ...
            <Field label="Meta title" hint="Defaults to report title if blank">
              <Input
